...
def submitSurvey(request):
    ...
    if user_obj.user_gender == '남':
        eSurvey.dormitory_number_man = request.POST.get('dormitory-number-man')
    else:
...
def mypageCheckupdate(request):
    ...
    if request.method == 'POST':
        ...
        if user.user_gender == '남':
            eSurvey.dormitory_number_man = request.POST.get('dormitory_number_man')
        else:
